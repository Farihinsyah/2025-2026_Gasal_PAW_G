...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <a href="user_tambah.php" class="button add">Tambah Data</a>
        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="user_edit.php?id=<?= $row['id_user'] ?>" class="button edit">Edit</a>
                        
                        <form method="POST" class="delete-form" id="delete-form-<?= $row['id_user'] ?>">
                            <input type="hidden" name="hapus" value="<?= $row['id_user'] ?>">
                            <button type="button" 
                                    class="button delete" 
                                    onclick="confirmDelete(<?= $row['id_user'] ?>, '<?= $row['nama'] ?>')">
                                Hapus
                            </button>
                        </form>
                    </div>

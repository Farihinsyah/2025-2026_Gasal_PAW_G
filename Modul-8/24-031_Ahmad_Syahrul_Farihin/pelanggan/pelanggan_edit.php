...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_POST['jenis_kelamin'] = $data['jenis_kelamin'];
    $_POST['telp'] = $data['telp'];
...
<body>
    ...
    <div class="container">
        ...
        <form method="POST">
            <input type="hidden" name="id_lama" value="<?= $_GET['id'] ?>">
            ...
            <div class="form-group">
                <label>Telepon</label>
                <input type="text" name="telp" value="<?= htmlspecialchars($_POST['telp'] ?? '') ?>">
            </div>

...
<head>
    ...
    <script>
        window.onload = function() {
            ...
            // Redirect setelah print selesai
            window.onafterprint = function() {
                window.location.href = 'laporan_detail.php';
            };
            
            // Fallback: redirect setelah 3 detik jika afterprint tidak bekerja
            setTimeout(() => {
                window.location.href = 'laporan_detail.php';
            }, 3000);
        };
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderColor: "ragba(54,162,235,1)",
                        borderWidth: 1
                    }]
                },
                options: { 

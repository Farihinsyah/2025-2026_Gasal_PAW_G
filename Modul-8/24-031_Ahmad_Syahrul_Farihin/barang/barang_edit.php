...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $_POST['kode_barang'] = $data['kode_barang'];
    $_POST['nama_barang'] = $data['nama_barang'];
    $_POST['harga'] = $data['harga'];
    ...
    <div class="container">
        ...
        <form method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode_barang" value="<?= htmlspecialchars($_POST['kode_barang'] ?? '') ?>">
            </div>
            <div class="error"><?= $error['kode_barang'] ?? '' ?></div>

            <div class="form-group">
                <label>Nama Barang</label>
                <input type="text" name="nama_barang" value="<?= htmlspecialchars($_POST['nama_barang'] ?? '') ?>">
            </div>
            <div class="error"><?= $error['nama_barang'] ?? '' ?></div>

            <div class="form-group">
                <label>Harga</label>
                <input type="number" name="harga" value="<?= htmlspecialchars($_POST['harga'] ?? '') ?>">
            </div>
            <div class="error"><?= $error['harga'] ?? '' ?></div>

            <div class="form-group">
                <label>Stok</label>
                <input type="number" name="stok" value="<?= htmlspecialchars($_POST['stok'] ?? '') ?>">
            </div>

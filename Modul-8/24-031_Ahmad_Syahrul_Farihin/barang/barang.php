...
$result = mysqli_query($conn, "SELECT barang.*, supplier.nama as nama_supplier 
                               FROM barang 
...
<body>
    ...
    <div class="container">
        <div class="header">
            ...
            <a href="barang_tambah.php" class="button add">Tambah Data</a>
        </div>
            ...
            <tr>
                ...
                <td>
                    <div class="action-buttons">
                        <a href="barang_edit.php?id=<?= $row['id'] ?>" class="button edit">Edit</a>
                        
                        <form method="POST" class="delete-form" id="delete-form-<?= $row['id'] ?>">
                            <input type="hidden" name="hapus" value="<?= $row['id'] ?>">
                            <button type="button" 
                                    class="button delete" 
                                    onclick="confirmDelete(<?= $row['id'] ?>, '<?= $row['nama_barang'] ?>')">
                                Hapus
                            </button>
                        </form>
                    </div>
